...
<body>
    ...
    <div class="container w-70" style="height: 800px;">
     ...
     <form class="form-horizontal" action="/ush/job/do_save" method="post">
          <div class="form-group">
             <label for="inputjobName" class="col-sm-2 control-label">职业名称：</label>
             <div class="col-sm-10">
                <input type="text" class="form-control" id="jobid" name="jobname" placeholder="职业名称...">
             </div>
         </div>
         <hr>
       <div class="form-group">
