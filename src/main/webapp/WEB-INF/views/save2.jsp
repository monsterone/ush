...
<body>
    ...
    <div class="container w-70" style="height: 800px;">
     ...
     <form class="form-horizontal" action="/ush/user/do_save" method="post">
          <div class="form-group">
             <label for="name" class="col-sm-2 control-label">职业名称：</label>
             <div class="col-sm-10">
                <input type="text" class="form-control" id="name" name="userModel.name" placeholder="职业名称...">
             </div>
             <label for="password" class="col-sm-2 control-label">登录密码：</label>
             <div class="col-sm-10">
                <input type="text" class="form-control" id="password" name="userModel.password" placeholder="登录密码...">
             </div>
             <label for="email" class="col-sm-2 control-label">电子邮箱：</label>
             <div class="col-sm-10">
                <input type="text" class="form-control" id="email" name="userModel.email" placeholder="电子邮箱...">
             </div>
         </div>
         <hr>
       <div class="form-group">
